...
<template>
  <InfoBlock class="overview" :title="'Обзор курса'">
    <p class="overview__description">
      Мы специально подготовили тизер курса чтобы вы смогли больше ознакомиться с тем что вас ждет. Курс поможет Вам сделать первые шаги в мире инвестиций и открыть новые
